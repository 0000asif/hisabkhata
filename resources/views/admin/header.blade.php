...
<nav class="navbar navbar-expand navbar-light fixed-top header">
    ...
    <i class="ft-user mr-3 font-18 text-muted"></i>Profile
</a>
<div class="dropdown-divider my-3"></div>
<div class="mx-4">
    <a class="btn btn-link p-0" href="javascript:void(0)" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
        <span class="btn-icon"><i class="ft-power mr-2 font-18"></i>Logout</span>
    </a>
</div>
