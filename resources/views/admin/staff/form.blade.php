            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <select name="position_id" class="form-control" required>
                  ...
                  <option value="{{ $position->id }}" {{ old('position_id', $staff->position_id ?? '') == $position->id
                    ? 'selected' : '' }}>
                    {{ $position->name }}
                  </option>
                  @endforeach
              ...
              <div class="col-md-3 mb-3">
                ...
                <select name="status" class="form-control" required>
                  ...
                  <option value="1" {{ old('status', $staff->status ?? '') == 1 ? 'selected' : '' }}>সক্রিয়</option>
                  <option value="0" {{ old('status', $staff->status ?? '') == 0 ? 'selected' : '' }}>নিষ্ক্রিয়</option>
                </select>
              </div>
              ...
              <div class="col-md-3 mb-3">
                ...
                <select name="feild" class="form-control" required>
                  ...
                  <option value="1" {{ old('feild', $staff->feild ?? '') == 1 ? 'selected' : '' }}>হ্যাঁ</option>
                  <option value="0" {{ old('feild', $staff->feild ?? '') == 0 ? 'selected' : '' }}>না</option>
                </select>
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="password" name="password_confirmation" class="form-control" {{ isset($staff) ? ''
                  : 'required' }}>
              </div>
